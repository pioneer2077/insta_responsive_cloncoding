  ...
  return (
    <div>
      <nav className=" fixed top-0 left-0 z-10 border px-3 py-2 box-border min-h-100vh max-tablet:hidden desktop:min-w-244px border-y-0">
        ...
        <ul>
          <li className=" flex w-full h-14 min-w-48px ">
            <div className=" flex w-full pl-3 my-1 rounded-md items-center justify-start hover:bg-secondary cursor-pointer">
              ...
              <p className=" pl-4  max-desktop:hidden ">홈</p>
            </div>
          </li>
          <li className=" flex w-full h-14 ">
            <div className=" flex w-full pl-3 my-1 rounded-md items-center justify-start hover:bg-secondary cursor-pointer">
              ...
              <p className=" pl-4  max-desktop:hidden ">검색</p>
            </div>
          </li>
          <li className=" flex w-full h-14 ">
            <div className=" flex w-full pl-3 my-1 rounded-md items-center justify-start hover:bg-secondary cursor-pointer">
              ...
              <p className=" pl-4  max-desktop:hidden ">탐색</p>
            </div>
          </li>
        </ul>
      </nav>
